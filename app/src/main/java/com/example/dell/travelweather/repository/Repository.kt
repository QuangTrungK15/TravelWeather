package com.example.dell.travelweather.repository

import com.example.dell.travelweather.BuildConfig
...
class Repository {
    ...
    companion object {
        ...
        private var builder: Retrofit.Builder = Retrofit.Builder().baseUrl(Common.Companion.BASE_API_LAYER)
